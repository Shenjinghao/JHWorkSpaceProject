//
//  UIFontDescriptor+JHFontSetting.m
//  测试Demo
//
...
#import "UIFontDescriptor+JHFontSetting.h"

NSString *const JHUIFontTextStyleCaption3 = @"JHUIFontTextStyleCaption3";
NSString *const JHUIFontTextStyleCaption4 = @"JHUIFontTextStyleCaption4";

@implementation UIFontDescriptor (JHFontSetting)
...
{
    return [[self preferredJHAvenirNextFontDescriptorWithTextStyle:style contentSizeStr:contentSizeStr] fontDescriptorWithSymbolicTraits:trait];
}
...
{
    return [UIFontDescriptor fontDescriptorWithName:[self preferredBoldFontName] size:[self preferredJHAvenirNextFontDescriptorWithTextStyle:style contentSizeStr:contentSizeStr].pointSize];
}

+ (NSString *)preferredFontName {
    return @"JHAvenirNext-Medium";
}

+ (NSString *)preferredBoldFontName {
    return @"JHAvenirNext-Bold";
}
